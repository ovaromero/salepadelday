  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-3xl shadow-2xl p-8 max-w-md w-full animate-in fade-in zoom-in duration-200">
        <h2 className="text-2xl font-black uppercase tracking-tight text-gray-800 mb-6 text-center">Cambiar Rivales</h2>
        ...
        <div className="space-y-6 mb-8">
          <div>
            ...
            <select
              ...
              className="w-full bg-gray-100 rounded-xl p-4 font-bold outline-none focus:ring-4 focus:ring-indigo-200 transition-all appearance-none"
            >
              {teams.map(team => (
